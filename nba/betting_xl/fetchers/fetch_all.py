...
from fetch_cheatsheet import CheatSheetFetcher
    ...
    def deduplicate_across_sources(self, all_props: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for prop in all_props:
            ...
            key = (
                ...
                round(float(prop.get('line', 0)), 1)  # Round to 1 decimal to catch minor variations
            )
    ...
    def _print_summary(self, result: Dict[str, Any]):
        ...
        if stats['multi_book_combos'] > 0:
            ...
            for i, spread_info in enumerate(stats['line_spreads'][:5], 1):
                print(f"  {i}. {spread_info['player']:20s} {spread_info['stat']:10s}: "
